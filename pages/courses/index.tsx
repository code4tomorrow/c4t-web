            ...
            <Animate>
                ...
                >
                    ...
                    <article className="md:w-1/2 w-full relative space-y-2 flex flex-col items-center">
                        ...
                        >
                            <h2 className="text-medium-grey text-center font-medium text-lg">
                                Choose as many as you want from Beginner to{" "}
                                <b>Advanced</b>.
                            </h2>
                        </Animate.Element>
                        <div
