...
const FullInternship : React.FC<IFullJobProps> = ({ internship, showContent:_showContent = true }) => {
    ...
    return (
        <article ref={containerRef} className="w-full transition-all h-full pb-4 space-y-3">
            ...
            <div className="px-4 space-y-2">
                <h2 className="font-bold text-white text-lg">Time Commitment</h2>
                        ...
                        <Animate.Element
                            ...
                            { internship.timeCommitment?.json ? 
                                <Document document={internship.timeCommitment.json} /> :
                                <p className="text-medium-grey">N/A</p>
                            }
                        </Animate.Element>
                ...
                <h2 className="font-bold text-white text-lg">Responsibilities</h2>
                {
                        ...
                        <Animate.Element
                            ...
                            { internship.responsibilities?.json ? 
                                <Document document={internship.responsibilities.json} /> :
                                <p className="text-medium-grey">N/A</p>
                            }
                        </Animate.Element>
                ...
                internship.realLifeJobs?.length && (
                    ...
                    <h2 className="font-bold text-white text-lg">Real-Life Careers</h2>
                            ...
                            <div className="[&>*]:mr-2 text-sm font-semibold">
                                    {
                                        internship.realLifeJobs?.map(((realLifeJob, i) => (
                                            <span 
                                                key={i}
                           ...
                           <div>
                                { internship.realLifeJobConnection?.json &&
                                    <Document document={internship.realLifeJobConnection.json} />
                                }
                           </div>
                            </Animate.Element>
