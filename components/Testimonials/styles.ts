...
export const useStyles = makeStyles()(() => ({
    sliderContainer: {
        ...
        zIndex: 1,
        "&::before, &::after": {
            boxShadow: "0px 0px 10px 10px #111111",
            content: "''",
            display: "block",
            zIndex: 10,
            height: "100%",
