            ...
            <Component onClick={handlePolymorphicClick} {...props}>
                <button
                    ...
                    className={clsx(
                        ...
                        classes.button,
                        variant === "gradient" &&
                            "bg-gradient-to-b from-brand-purple-primary to-brand-purple-secondary",
                ...
                {label && (
                    <div
                        ...
                        className="absolute flex items-end left-1/2"
                    >
...
export default React.forwardRef(BrandButton) as <
    T extends React.ElementType = "div",
    R = HTMLDivElement
>(
    props: BrandButtonProps<T> &
