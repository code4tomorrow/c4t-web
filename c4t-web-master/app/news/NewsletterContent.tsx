...
const NewsletterContent: React.FC<NewsletterContentProps> = ({
    ...
    const [currentNewsletter, setCurrentNewsletter] = useState<INewsletter>(
        newsletters[0]
    );
    ...
    const [primaryWidth, primaryHeight] = useMemo(() => {
        ...
        currentNewsletter.graphic.height,
        currentNewsletter.graphic.width,
        width,
    ]);
    ...
    return (
        <main className="flex overflow-x-hidden lg:flex-row flex-col h-full justify-center mt-16 lg:px-8 px-4">
            <div
                id="highlighted-newsletter"
                className="lg:w-1/2 w-full h-full flex flex-col space-y-3 items-center"
            >
            ...
            <Animate>
                <div className="lg:px-4 lg:w-1/2 w-full mt-16 lg:mt-0 flex-col items-center">
                    ...
                    <h2 className="text-medium-grey text-center mt-4">
                        Subscribe to our Newsletter to stay up-to-date on all
                        the <b>Extraordinary</b> things occurring at C4T!
                    </h2>
